...
from ts_benchmark.baselines.NPMoETSF.utils.tools import EarlyStopping, adjust_learning_rate
...
from ts_benchmark.baselines.NPMoETSF.models.NPMoETSF_model import NPMoETSFModel
...
class NPMoETSF(ModelBase):
    def __init__(self, **kwargs):
        super(NPMoETSF, self).__init__()
    ...
    def forecast_fit(
        ...
        self.model = NPMoETSFModel(self.config)
