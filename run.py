...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = '[NPMoETSF] Long Sequences Forecasting')
    parser.add_argument('--model', type = str, required = False, choices = ['NPMoETSF'], default = 'NPMoETSF',help = 'model of experiment')
