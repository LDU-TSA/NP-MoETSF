...
import numpy as np
from models.wavelet_patch_mixer import NPMoETSFCore

class NPMoETSFWrapperShortTermForecast(nn.Module):
    def __init__(self,
                 c_in = [], 
                 c_out = [],
                 seq_len = [],
...
class NPMoETSF(nn.Module):
    def __init__(self,
        ...
        self.NPMoETSFCore = NPMoETSFCore(input_length = self.actual_seq_len,
